...
import com.hui.o2o.dao.ProductImgDao;
...
import com.hui.o2o.util.ImageUtil;
import com.hui.o2o.util.PageCalculator;
import com.hui.o2o.util.PathUtil;
...
public class ProductServiceImpl implements ProductService {
	...
	public ProductExecution getProductList(Product productCondition, int pageIndex, int pageSize) {
		// 页面转换成数据库的行码，并调用dao层取回指定页码的商品列表
